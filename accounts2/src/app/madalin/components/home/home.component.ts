...
export class HomeComponent {
  ...
  ratingOptions: FilterOption[] = [
    { value: 'Positive' }, { value: 'Negative' }, { value: '-', label: '—' }
  ];
  ...
  private allRows: (AccountRow & { updatedAt?: string; server?: string; discounted?: boolean })[] = [
    { id: 1,  title: 'Starter Bundle — 8 Skins',               game: 'Fortnite',                       accountId: '#100231', credentials: 'starter@demo.com:pass',        status: 'Listed',      views: 312, price: '€24.99', rating: 'Positive', updated: '2 days ago',    updatedAt: '2025-08-16', server: 'EU',  discounted: true ,imageUrl:'assets/images/wal.jpg' },
    { id: 2,  title: 'Gold IV Midlane Main',                    game: 'League of Legends',              accountId: '#100232', credentials: 'lol.gold@demo.com:pass',        status: 'Refounded',   views: 88,  price: '€29.00', rating: 'Positive',  updated: '1 week ago',   updatedAt: '2025-08-10', server: 'EU'                       },
    ...
    { id: 7,  title: 'TH12 • Max Walls • Clan 10',              game: 'Clash of Clans',                 accountId: '#100237', credentials: 'coc.th12@demo.com:pass',        status: 'Listed',      views: 73,  price: '€34.50', rating: 'Positive',  updated: '3 weeks ago',  updatedAt: '2025-07-28', server: 'ASIA'                     },
    ...
    { id:10,  title: 'FFXIV • Endwalker Unlocked',              game: 'Final Fantasy XIV',              accountId: '#100240', credentials: 'ffxiv.ew@demo.com:pass',        status: 'Unlisted',    views: 8,   price: '€42.00', rating: 'Positive',  updated: '2 months ago', updatedAt: '2025-06-18', server: 'NA'                       },
    ...
    { id:14,  title: 'Survivor Mastery 500 • Skins',            game: 'PUBG',                           accountId: '#100244', credentials: 'pubg.m500@demo.com:pass',       status: 'Refounded',   views: 64,  price: '€23.99', rating: 'Positive',  updated: '9 days ago',   updatedAt: '2025-08-09', server: 'ASIA'                     },
    { id:15,  title: 'Fennec + Octane • GC',                    game: 'Rocket League',                   accountId: '#100245', credentials: 'rl.gc@demo.com:pass',           status: 'Disputed',    views: 25,  price: '€31.00', rating: 'Positive',        updated: '3 weeks ago',  updatedAt: '2025-07-29', server: 'EU'                       },
    ...
    { id:17,  title: 'Tier 3 • Argos Clear',                    game: 'Lost Ark',                       accountId: '#100247', credentials: 'la.t3@demo.com:pass',           status: 'Unlisted',    views: 77,  price: '€28.00', rating: 'Positive',  updated: '10 days ago',  updatedAt: '2025-08-08', server: 'EU'                       },
    { id:18,  title: 'Lightfall • 1810 Power',                  game: 'Destiny 2',                      accountId: '#100248', credentials: 'd2.1810@demo.com:pass',         status: 'Listed',      views: 5,   price: '€26.50', rating: 'Positive',        updated: '2 months ago', updatedAt: '2025-06-20', server: 'NA'                       }
  ];
